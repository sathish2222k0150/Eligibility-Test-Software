...
class Staff {
    ...
    public function updateAssignedCourses($staffId, $courseIds) {
        ...
        public function getCompletedAttempts($staffId, $page = 1, $perPage = 15) {
        ...
        // Add a LIMIT clause for pagination
        ...
        // Get the total count for the pagination links
        $totalRows = $this->db->query("SELECT FOUND_ROWS()")->fetchColumn();

        // Return the data in a structured array
        return [
            'attempts' => $attempts,
            'total'    => $totalRows,
            'page'     => $page,
